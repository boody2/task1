                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="row p-2  align-items-center justify-content-center">
                            ...
                            <div class="col-md">
                                ...
                                <input type="text" name='name'class="form-control border p-1" id="name"  value="{{Auth()->user()->name}}" required>
                            </div>
                            <div class="col-md">
                            ...
                            <div class="col-md">
                                ...
                                <select disabled class="form-select p-1" name="type" id="type" aria-label="Type *"
                                    required>
                                    <option value="Employee" @if (Auth()->user()->type=="Employee")
                                        selected
                                    @endif>Employee</option>
                                    <option value="Admin"@if (Auth()->user()->type=="Admin")
                                        selected
                                    @endif >Admin</option>
                                </select>
                            </div>
                            <div class="col-md pt-5">
                                ...
                                <button class="btn bg-gradient-primary w-100" type="submit">update profile</button>
                            </div>
